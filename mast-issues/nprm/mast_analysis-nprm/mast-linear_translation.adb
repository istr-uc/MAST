...
with Mast.Systems, Mast.Transactions, Mast.Graphs, Mast.Graphs.Links,
  ...
  Mast.Processing_Resources.Network, Mast.Schedulers, Mast.Scheduling_Policies,
...
package body Mast.Linear_Translation is
   ...
   is
	...
	(Current_Trans_Id     : in Transaction_ID_Type;
	 Trans_Ref            : in Mast.Transactions.Transaction_Ref;
	 External_Event_Ref   : in Mast.Events.Event_Ref;
	 The_Link_Ref         : in Mast.Graphs.Link_Ref;
	 Index                : in Transaction_ID_Type;
	 Prev_Processor_Val   : in Prev_Processor_Values_Type;
	 Prev_Handler_Val     : in Prev_Handler_Values_Type;
	 ...
	 then
		 ...
		 -- there is a timer
		 and then not 
		 (J=1 and Transaction (I).Trans_Input_Type = Internal)
	 ...
	 if Independent_Tasks then
      ...
      Prev_Proc_Values     : Prev_Processor_Values_Type:=(None,null,null);
   ...
   --Show_Deadlines just for tests
   procedure Show_response (Transaction : in Linear_Transaction_System) is
      Extra : Transaction_ID_Type;
      I     : Transaction_ID_Type;
   begin
      I := 1;
