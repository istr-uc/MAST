...
package body Mast.Linear_Task_Analysis_Tools is
   ...
   is
      ...
      debug : Boolean := true;--(I=1) and (J=2) and debug_global;
            ...
            for I in Transaction_ID_Type range 1 .. Max_Transactions loop
               ...
               for J in 1 .. Transaction (I).Ni loop
                  ...
                  then
                     ...
                     Wc := Wc + (Floor((Wcant+Jitter)/Transaction(I).The_Task(J).Tij)+1.0)*Transaction(I).The_Task(J).Cij;  --Floor+1 instead of Ceiling
                  end if;
               end loop;
            end loop;
      ...
      then
         if Transaction(I).The_Task(J).Preemptible then
            ...
            for K in 0..Integer(Qm)-1 loop
               ...
               Want := Wm;
               Rm := Transaction(I).The_Task(J).Jij + Wm - Time_Interval(K)*Ti + Ci;
               if Verbose then
