...
package body Mast_Editor_Window_Pkg.Callbacks is
   ...
   begin
      ...
      File_Execution.Execute_Command("gmast_analysis",No_Arguments,Success);
   ...
   exception
         when File_Execution.Program_Not_Found =>
            Button:=Message_Dialog
              ("Warning: "&Message.all,
               Help_Msg => "Check that the program is configured in the PATH");
   ...
   exception
         when File_Execution.Program_Not_Found =>
            Button:=Message_Dialog
              ("Warning: gmast_results viewer or mast_results_command file"&
                 " not found",
               Help_Msg => "Check that the program is configured in the PATH");
