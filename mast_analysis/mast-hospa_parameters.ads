...
package Mast.HOSPA_Parameters is
   ...
   type Valid_Initial_Assignments is (PD,NPD,USER);
   ...
   procedure Load_Parameters
     (File_Name : in String := "assignment_parameters.txt");
   ...
   procedure Set_Stop_Factor_When_Not_Schedulable (Stop_Factor : in Positive);
