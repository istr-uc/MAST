...
--                                                                   --
-----------------------------------------------------------------------
with Mast.Processing_Resources, Mast.HOSPA_Parameters,
...
with Ada.Text_IO, Ada.Integer_Text_IO, Ada.Numerics.Discrete_Random,
  Ada.Numerics.Float_Random, Ada.Numerics.Generic_Elementary_Functions,
         ...
         while My_System (I).Ni /= 0 loop
            ...
            for K in 0 .. Extra loop
               for J in 1 .. My_System (I + K).Ni loop
                  ...
                  if not (My_System (I + K).The_Task (J).Pav.Preassigned and
	 ...
	 Translation.Clear_Time_Results(My_System,The_System);
      ...
      procedure Initialize_Deadlines_PD is
         ...
         Max_Factor                              : constant Time :=
            Large_Time;
         Max_D, Sum_C, Sum_D, Assigned_D, Factor : Time;
...
--           end if;
      ...
      procedure Initialize_Deadlines_NPD is
         ...
         Max_Factor                              : constant Time :=
            Large_Time;
         Max_D, Sum_C, Assigned_D, Factor, Sum_D : Time;
	 ...
	 Translation.Clear_Time_Results(My_System,The_System);
         ...
         Local_To_Global_Deadlines;       -- SDij -> SDij (Global)
         Translation.Translate_Deadlines_and_Priorities
           (My_System,The_System); -- SDij/Prioij -> The_System
            ...
            for J in 1 .. HOSPA_Parameters.Size_Of_K_List loop
               ...
               for L in 1 .. Max_Iter loop
                  ...
                  exit when Stop_Algorithm or
                            ((I = HOSPA_Parameters.Size_Of_Iterations_List) and
                             (J = HOSPA_Parameters.Size_Of_K_List) and
                             (L = Max_Iter));
