...
package Mast.Linear_Translation is
   ...
   -- Returns a number identifying the processing resource
   -- The processor numbers are consecutive, in the order of the 
   -- processing resources list contained in the system passed in 
   -- the arguments 
