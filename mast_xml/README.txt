...
- Requires the gnat compiler (libre.adacore.com). We have used the
  GPL2014 version of gnat in Linux and in Windows.
...
- Compile the conversion tools:
    ...
    command in directory mast_xml:
       ...
       gnatmake -g -I../mast_analysis -I../utils -aIc:/GNAT/2014/include/xmlada mast_xml_convert
       gnatmake -g -I../mast_analysis -I../utils -aIc:/GNAT/2014/include/xmlada mast_xml_convert_results

    assuming that gnat is installed in c:\GNAT\2014\
