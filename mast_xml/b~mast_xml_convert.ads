...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#936ff0ab#;
   ...
   u00248 : constant Version_32 := 16#d2aa1150#;
   pragma Export (C, u00248, "mast_xml_exceptionsB");
   u00249 : constant Version_32 := 16#1632c341#;
   pragma Export (C, u00249, "mast_xml_exceptionsS");
   u00250 : constant Version_32 := 16#a3a6fce7#;
   pragma Export (C, u00250, "mast_xml_parserB");
   u00251 : constant Version_32 := 16#b9538c54#;
   pragma Export (C, u00251, "mast_xml_parserS");
   u00252 : constant Version_32 := 16#2bd88f63#;
   pragma Export (C, u00252, "domS");
   u00253 : constant Version_32 := 16#b389c3e3#;
   pragma Export (C, u00253, "dom__coreB");
   u00254 : constant Version_32 := 16#e16c7fd0#;
   pragma Export (C, u00254, "dom__coreS");
   u00255 : constant Version_32 := 16#17965ec6#;
   pragma Export (C, u00255, "saxS");
   u00256 : constant Version_32 := 16#5c0f0294#;
   pragma Export (C, u00256, "sax__encodingsS");
   u00257 : constant Version_32 := 16#addc9f2f#;
   pragma Export (C, u00257, "unicodeB");
   u00258 : constant Version_32 := 16#a421878d#;
   pragma Export (C, u00258, "unicodeS");
   u00259 : constant Version_32 := 16#9d44d325#;
   pragma Export (C, u00259, "ada__wide_charactersS");
   u00260 : constant Version_32 := 16#8ae438bb#;
   pragma Export (C, u00260, "ada__wide_characters__unicodeB");
   u00261 : constant Version_32 := 16#7ae4a0bf#;
   pragma Export (C, u00261, "ada__wide_characters__unicodeS");
   u00262 : constant Version_32 := 16#27ccf663#;
   pragma Export (C, u00262, "system__utf_32B");
   u00263 : constant Version_32 := 16#23ffef99#;
   pragma Export (C, u00263, "system__utf_32S");
   u00264 : constant Version_32 := 16#5ae6f8f8#;
   pragma Export (C, u00264, "unicode__namesS");
   u00265 : constant Version_32 := 16#e0b5339a#;
   pragma Export (C, u00265, "unicode__names__basic_latinS");
   u00266 : constant Version_32 := 16#6a391607#;
   pragma Export (C, u00266, "unicode__cesB");
   u00267 : constant Version_32 := 16#ed91c982#;
   pragma Export (C, u00267, "unicode__cesS");
   u00268 : constant Version_32 := 16#b37b69da#;
   pragma Export (C, u00268, "unicode__ces__utf32B");
   u00269 : constant Version_32 := 16#e40e527d#;
   pragma Export (C, u00269, "unicode__ces__utf32S");
   u00270 : constant Version_32 := 16#50a7378d#;
   pragma Export (C, u00270, "unicode__ccsB");
   u00271 : constant Version_32 := 16#bc6fae53#;
   pragma Export (C, u00271, "unicode__ccsS");
   u00272 : constant Version_32 := 16#23a227bd#;
   pragma Export (C, u00272, "unicode__ces__utf8B");
   u00273 : constant Version_32 := 16#38b0aa20#;
   pragma Export (C, u00273, "unicode__ces__utf8S");
   u00274 : constant Version_32 := 16#f78b28e4#;
   pragma Export (C, u00274, "sax__symbolsB");
   u00275 : constant Version_32 := 16#9d983edf#;
   pragma Export (C, u00275, "sax__symbolsS");
   u00276 : constant Version_32 := 16#fd2ad2f1#;
   pragma Export (C, u00276, "gnatS");
   u00277 : constant Version_32 := 16#00e9dcb1#;
   pragma Export (C, u00277, "gnat__task_lockS");
   u00278 : constant Version_32 := 16#0881bbf8#;
   pragma Export (C, u00278, "system__task_lockB");
   u00279 : constant Version_32 := 16#dcfc313b#;
   pragma Export (C, u00279, "system__task_lockS");
   u00280 : constant Version_32 := 16#35181bfa#;
   pragma Export (C, u00280, "sax__htableB");
   u00281 : constant Version_32 := 16#53cdfad2#;
   pragma Export (C, u00281, "sax__htableS");
   u00282 : constant Version_32 := 16#525d8a03#;
   pragma Export (C, u00282, "sax__pointersB");
   u00283 : constant Version_32 := 16#ce4508b8#;
   pragma Export (C, u00283, "sax__pointersS");
   u00284 : constant Version_32 := 16#d33c21cc#;
   pragma Export (C, u00284, "sax__utilsB");
   u00285 : constant Version_32 := 16#8be8edc4#;
   pragma Export (C, u00285, "sax__utilsS");
   u00286 : constant Version_32 := 16#d6cfcab7#;
   pragma Export (C, u00286, "dom__core__attrsB");
   u00287 : constant Version_32 := 16#4f3aef62#;
   pragma Export (C, u00287, "dom__core__attrsS");
   u00288 : constant Version_32 := 16#1badb9ca#;
   pragma Export (C, u00288, "dom__core__nodesB");
   u00289 : constant Version_32 := 16#dd9b1d29#;
   pragma Export (C, u00289, "dom__core__nodesS");
   u00290 : constant Version_32 := 16#eeeb4b65#;
   pragma Export (C, u00290, "ada__text_io__text_streamsB");
   u00291 : constant Version_32 := 16#d41c52c3#;
   pragma Export (C, u00291, "ada__text_io__text_streamsS");
   u00292 : constant Version_32 := 16#593b2f4b#;
   pragma Export (C, u00292, "unicode__encodingsB");
   u00293 : constant Version_32 := 16#0dd3cf4a#;
   pragma Export (C, u00293, "unicode__encodingsS");
   u00294 : constant Version_32 := 16#fb79a56a#;
   pragma Export (C, u00294, "unicode__ccs__iso_8859_1B");
   u00295 : constant Version_32 := 16#8e38bcbd#;
   pragma Export (C, u00295, "unicode__ccs__iso_8859_1S");
   u00296 : constant Version_32 := 16#82996ee0#;
   pragma Export (C, u00296, "unicode__ccs__iso_8859_15B");
   u00297 : constant Version_32 := 16#92feba06#;
   pragma Export (C, u00297, "unicode__ccs__iso_8859_15S");
   u00298 : constant Version_32 := 16#f4a53196#;
   pragma Export (C, u00298, "unicode__names__currency_symbolsS");
   u00299 : constant Version_32 := 16#ef6463a7#;
   pragma Export (C, u00299, "unicode__names__latin_1_supplementS");
   u00300 : constant Version_32 := 16#c09150ac#;
   pragma Export (C, u00300, "unicode__names__latin_extended_aS");
   u00301 : constant Version_32 := 16#60f426d2#;
   pragma Export (C, u00301, "unicode__ccs__iso_8859_2B");
   u00302 : constant Version_32 := 16#349a01be#;
   pragma Export (C, u00302, "unicode__ccs__iso_8859_2S");
   u00303 : constant Version_32 := 16#69ed8ca4#;
   pragma Export (C, u00303, "unicode__names__spacing_modifier_lettersS");
   u00304 : constant Version_32 := 16#08a5bdd8#;
   pragma Export (C, u00304, "unicode__ccs__iso_8859_3B");
   u00305 : constant Version_32 := 16#487a726a#;
   pragma Export (C, u00305, "unicode__ccs__iso_8859_3S");
   u00306 : constant Version_32 := 16#34be6191#;
   pragma Export (C, u00306, "unicode__ccs__iso_8859_4B");
   u00307 : constant Version_32 := 16#ad57c2bd#;
   pragma Export (C, u00307, "unicode__ccs__iso_8859_4S");
   u00308 : constant Version_32 := 16#4acde028#;
   pragma Export (C, u00308, "unicode__ccs__windows_1251B");
   u00309 : constant Version_32 := 16#ba76c289#;
   pragma Export (C, u00309, "unicode__ccs__windows_1251S");
   u00310 : constant Version_32 := 16#e75ad8ad#;
   pragma Export (C, u00310, "unicode__names__cyrillicS");
   u00311 : constant Version_32 := 16#f37cfd49#;
   pragma Export (C, u00311, "unicode__names__general_punctuationS");
   u00312 : constant Version_32 := 16#9b0ee482#;
   pragma Export (C, u00312, "unicode__names__letterlike_symbolsS");
   u00313 : constant Version_32 := 16#e1e1e768#;
   pragma Export (C, u00313, "unicode__ccs__windows_1252B");
   u00314 : constant Version_32 := 16#7cee5e39#;
   pragma Export (C, u00314, "unicode__ccs__windows_1252S");
   u00315 : constant Version_32 := 16#989dc321#;
   pragma Export (C, u00315, "unicode__names__latin_extended_bS");
   u00316 : constant Version_32 := 16#ba342546#;
   pragma Export (C, u00316, "unicode__ces__basic_8bitB");
   u00317 : constant Version_32 := 16#4161d344#;
   pragma Export (C, u00317, "unicode__ces__basic_8bitS");
   u00318 : constant Version_32 := 16#ad1d2052#;
   pragma Export (C, u00318, "unicode__ces__utf16B");
   u00319 : constant Version_32 := 16#76c334e3#;
   pragma Export (C, u00319, "unicode__ces__utf16S");
   u00320 : constant Version_32 := 16#62e0a466#;
   pragma Export (C, u00320, "dom__core__documentsB");
   u00321 : constant Version_32 := 16#9493378d#;
   pragma Export (C, u00321, "dom__core__documentsS");
   u00322 : constant Version_32 := 16#65b22764#;
   pragma Export (C, u00322, "dom__core__elementsB");
   u00323 : constant Version_32 := 16#92281457#;
   pragma Export (C, u00323, "dom__core__elementsS");
   u00324 : constant Version_32 := 16#4a2302be#;
   pragma Export (C, u00324, "dom__readersB");
   u00325 : constant Version_32 := 16#cf2b8dfd#;
   pragma Export (C, u00325, "dom__readersS");
   u00326 : constant Version_32 := 16#9ff1faba#;
   pragma Export (C, u00326, "dom__core__character_datasB");
   u00327 : constant Version_32 := 16#06ea1232#;
   pragma Export (C, u00327, "dom__core__character_datasS");
   u00328 : constant Version_32 := 16#5f2d0fd4#;
   pragma Export (C, u00328, "sax__attributesB");
   u00329 : constant Version_32 := 16#5ab7981b#;
   pragma Export (C, u00329, "sax__attributesS");
   u00330 : constant Version_32 := 16#33d920a6#;
   pragma Export (C, u00330, "sax__modelsB");
   u00331 : constant Version_32 := 16#9f60b983#;
   pragma Export (C, u00331, "sax__modelsS");
   u00332 : constant Version_32 := 16#28a5338f#;
   pragma Export (C, u00332, "sax__exceptionsB");
   u00333 : constant Version_32 := 16#668a9cba#;
   pragma Export (C, u00333, "sax__exceptionsS");
   u00334 : constant Version_32 := 16#39333ede#;
   pragma Export (C, u00334, "sax__locatorsB");
   u00335 : constant Version_32 := 16#aaab08ab#;
   pragma Export (C, u00335, "sax__locatorsS");
   u00336 : constant Version_32 := 16#30049777#;
   pragma Export (C, u00336, "gnat__directory_operationsB");
   u00337 : constant Version_32 := 16#3cebe1d6#;
   pragma Export (C, u00337, "gnat__directory_operationsS");
   u00338 : constant Version_32 := 16#ebb9e033#;
   pragma Export (C, u00338, "gnat__os_libS");
   u00339 : constant Version_32 := 16#afc4e887#;
   pragma Export (C, u00339, "sax__readersB");
   u00340 : constant Version_32 := 16#e0248d2a#;
   pragma Export (C, u00340, "sax__readersS");
   u00341 : constant Version_32 := 16#99536319#;
   pragma Export (C, u00341, "input_sourcesB");
   u00342 : constant Version_32 := 16#ef327363#;
   pragma Export (C, u00342, "input_sourcesS");
   u00343 : constant Version_32 := 16#82ec19c4#;
   pragma Export (C, u00343, "input_sources__fileB");
   u00344 : constant Version_32 := 16#e1007772#;
   pragma Export (C, u00344, "input_sources__fileS");
   u00345 : constant Version_32 := 16#bdfdf422#;
   pragma Export (C, u00345, "input_sources__stringsB");
   u00346 : constant Version_32 := 16#d2561cff#;
   pragma Export (C, u00346, "input_sources__stringsS");
   u00347 : constant Version_32 := 16#4b37b589#;
   pragma Export (C, u00347, "system__val_enumB");
   u00348 : constant Version_32 := 16#066c44c0#;
   pragma Export (C, u00348, "system__val_enumS");
